...
class NemotronAWQForCausalLM(BaseAWQForCausalLM):
    layer_type = "NemotronDecoderLayer"
    max_seq_len_key = "max_position_embeddings"

    @staticmethod
    def fuse_layers(model):
        raise NotImplementedError("Fusing layers for Nemotron is not supported yet.")
...
class GraniteAWQForCausalLM(BaseAWQForCausalLM):
